...
Variables analyzed include air temperature, wind speed, cloud cover, dew point (not shown), and precipitation.
...
We analyze ice phenology, trends and relationships to both lake morphometrics and meteorological and marine data. This analysis is described in detail in the following sections.

\subsection{Metrics}

$$ Ice duration = \sum_{Nov}^{May} Ice $$
$$ Seasonal Average  = \frac{1}{N} \sum_{Jan-01}^{Mar-30} Ice $$



\subsection{Ice Trends and Morphometrics}

\subsection{Correlations with \emph{in-situ} dataCorrelations with \emph{in-situ} data}
