...
The following ice metrics are used to analyze ice cover: annual max ice cover (AMIC), seasonal average ice cover (JFM), ice duration, ice onset and ice breakup.  

\begin{equation} 
	\textup{Ice Duration} = \sum_{Nov}^{May} 
	\begin{cases} 
		1 & x > 10 \\
		0 & x \le 10 \\
	\end{cases}
...
\begin{equation} 
	\textup{Seasonal Average}  = \frac{1}{N} \sum_{Jan-01}^{Mar-30} Ice
\end{equation} 
